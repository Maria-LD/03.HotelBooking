        ...
        try {
            ...
            if (!("may".equals(month)) && !("june".equals(month)) && !("july".equals(month)) &&
                ...
                if (nightsCount <= 0 || nightsCount > 200) {
                    System.out.println("Invalid month or bad spelling of month! Try again, please! " +
                    ...
                    System.out.println("Invalid input - mistake in number of nights! Try again, please! " +
                    ...
                    System.out.println("Invalid month or bad spelling! Try again, please! " +
                            "Keep in mind that we offer rooms only for " +
                            "May, June, July, August, September, October and December" +
                            "(the first letter could be both capital or low)!");
                }
            ...
            } else if (nightsCount <= 0 || nightsCount > 200) {
